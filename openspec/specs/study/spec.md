...
- When entering the confirmation state, the question text and creation date remain continuously visible, and the row container provides appropriate ARIA labeling (`role="group"` with `aria-labelledby`).
